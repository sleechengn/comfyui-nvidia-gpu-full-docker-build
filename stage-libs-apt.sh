...
#python3.11 -m pip install --use-deprecated=html5lib --trusted-host 192.168.13.81 --index-url=http://192.168.13.81:8081/repository/python-lan/ --target=/opt/ComfyUI/python-lib -r /opt/ComfyUI/requirements.txt
...
#python3.11 -m pip install --use-deprecated=html5lib --trusted-host 192.168.13.81 --index-url=http://192.168.13.81:8081/repository/python-lan/ --target=/opt/ComfyUI/python-lib async_timeout ultralytics!=8.2.5 diffusers==0.25.0 -r /opt/requirements.txt
